    ...
    <>
      <div className="mt-24">
        <div className="m-4">
          ...
          <p className="text-[#484848] text-center ">
        ...
        <div className="mt-24 ">
          <div className="md:flex md:flex-row flex flex-col ml-8">
            <div className="w-[320px] h-[308px] mt-6 relative">
              ...
              <a
                href="#"
                className="absolute top-0 left-0 w-full h-full flex items-center justify-center bg-black bg-opacity-75 opacity-0 hover:opacity-100 transition-opacity duration-300"
              >
                <img
                  src={instagramLogo}
                  alt="Instagram Logo"
